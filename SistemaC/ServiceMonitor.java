...
class ServiceMonitor extends Thread
{
	...
	public ServiceMonitor()
	{
		...
		{
			System.out.println("ECSServiceMonitor::Error instantiating event manager interface: " + e);
			Registered = false;
	...
	public ServiceMonitor( String EvmIpAddress )
	{
...
/*
	...
	***************************************************************************/
	...
	public void eventPing()
	{
		...
		evt = new Event( (int) 10, "Ping devices" );
